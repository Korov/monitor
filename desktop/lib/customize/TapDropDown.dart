...
class TapDropdownButton<T> extends StatefulWidget {
  ...
  final AsyncValueGetter<List<DropdownMenuItem<T>>?>? onTap;
  ...
  @override
  State<TapDropdownButton<T>> createState() => _TapDropdownButtonState<T>();
}

class _TapDropdownButtonState<T> extends State<TapDropdownButton<T>>
  ...
  @override
  void didUpdateWidget(TapDropdownButton<T> oldWidget) {
...
class DropdownButtonFormField<T> extends FormField<T> {
  ...
  DropdownButtonFormField({
    ...
    Widget? disabledHint,
    required this.onChanged,
    required AsyncValueGetter<List<DropdownMenuItem<T>>?> onTap,
    int elevation = 8,
    TextStyle? style,
    Widget? icon,
            ...
            return Focus(
              ...
              child: Builder(builder: (BuildContext context) {
                return DropdownButtonHideUnderline(
                  child: TapDropdownButton<T>._formField(
                    items: items,
